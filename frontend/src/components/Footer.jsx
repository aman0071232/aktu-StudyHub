        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-2">
              ...
              <SocialButton icon={<GitBranch size={16} />} />
...
function SocialButton({ icon }) {
  return (
    <button className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-[#aaa0ad] transition duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/10 hover:text-white">
      {icon}
    </button>
  );
}
